...
public class question_3 extends AppCompatActivity {
    ...
    private String question = "3) What is the name of the youngest Formula 1 World Champion?";
    private String[] options = {"Lewis Hamilton" , "Sebastian Vettel" , "Fernando Alonso" , "Max Verstappen"};
