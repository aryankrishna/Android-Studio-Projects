...
public class question_8 extends AppCompatActivity {
    ...
    private String question = "8) How many laps are typically raced in a Formula 1 Grand Prix?";
    private String[] options = {"50-60 laps" , "70-80 laps" , "90-100 laps" , "110-120 laps"};
    ...
    public void checkAnswer(View view) {
        ...
        if (selectedOptionId != -1) {
            ...
            Intent intent = new Intent(this, question_9.class);
