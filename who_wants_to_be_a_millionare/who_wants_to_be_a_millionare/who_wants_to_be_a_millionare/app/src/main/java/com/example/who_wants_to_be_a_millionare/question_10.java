...
public class question_10 extends AppCompatActivity {
    ...
    private String question = "10) What is the name of the current CEO of Formula 1?";
    private String[] options = {"Chase Carey" , "Stefano Domenicali" , "Toto Wolff" , "Christian Horner"};
    ...
    public void checkAnswer(View view) {
        ...
        if (selectedOptionId != -1) {
            ...
            Intent intent = new Intent(this, question_11.class);
