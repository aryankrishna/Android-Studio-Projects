...
public class question_9 extends AppCompatActivity {
    ...
    private String question = "9) Which Grand Prix circuit is famous for its high-speed corners such as Eau Rouge and Blanchimont?";
    private String[] options = {"Monza" , "Spa-Francorchamps" , "Silverstone" , "Suzuka"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        earnedAmountTextView.setTextSize(25);
    ...
    public void checkAnswer(View view) {
        ...
        if (selectedOptionId != -1) {
            ...
            Intent intent = new Intent(this, question_10.class);
