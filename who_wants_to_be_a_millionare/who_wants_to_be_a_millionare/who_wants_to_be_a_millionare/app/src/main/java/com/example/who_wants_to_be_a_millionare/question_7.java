...
public class question_7 extends AppCompatActivity {
    ...
    private String question = "7) Who is the only driver to have won a Formula 1 World Championship with a team other than Ferrari, Mercedes, or Red Bull Racing since 2010?";
    private String[] options = {"Nico Rosberg" , " Jenson Button" , " Kimi Räikkönen" , " Daniel Ricciardo"};
    private int correctAnswerIndex = 2; // Index of correct answer in options array
    ...
    public void checkAnswer(View view) {
        ...
        if (selectedOptionId != -1) {
            ...
            Intent intent = new Intent(this, question_8.class);
