...
public class CourseRVAdapter extends RecyclerView.Adapter<CourseRVAdapter.ViewHolder> {
    ...
    // constructor
    public CourseRVAdapter(ArrayList<StudentModal> courseModalArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.courseDescTV.setText(modal.getClassPriority());
        holder.courseDurationTV.setText(modal.getCwid());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("priority", modal.getClassPriority());
                i.putExtra("coursename", modal.getCourseName());
                i.putExtra("cwid", modal.getCwid());
